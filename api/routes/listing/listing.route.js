...
import { createListing, fetchUserListings,deleteListingById, updateListingById , fetchListingById, fetchCreatedListings} from '../../controllers/listing/listing.controller.js';
...
router.get('/fetchCreatedListings', fetchCreatedListings);
