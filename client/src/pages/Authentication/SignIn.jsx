    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center mt-48">
        <form
          ...
          className="w-full max-w-md shadow-xl bg-slate-100 rounded-3xl p-5 text-center"
        >
          ...
          <button
            ...
            disabled={loading}
            className={
              "bg-blue-500 w-10/12 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition duration-300 " +
